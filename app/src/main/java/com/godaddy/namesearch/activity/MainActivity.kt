...
class MainActivity : AppCompatActivity() {
    ...
    fun loadSearchFragment() {
        supportFragmentManager.beginTransaction()
            .replace(R.id.main_activity_container, SearchFragment.newInstance())
            .commit()
    }

    fun loadCartFragment() {
        supportFragmentManager.beginTransaction()
            .replace(R.id.main_activity_container, CartFragment.newInstance())
            .commit()
    }

    fun loadPaymentFragment() {
        supportFragmentManager.beginTransaction()
            .replace(R.id.main_activity_container, PaymentFragment.newInstance())
            .commit()
    }
}